...
import { Assessment, Content } from "../../../../interfaces/courses/responses/Course";
...
interface EditContentModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onSave: (updatedContent: Partial<Content>) => void;
  loading: boolean;
}

export function MEditContentModal({
  content,
  isOpen,
  onClose,
  onSave,
  ...
  const [editedContent, setEditedContent] = useState<Partial<Content>>(content);
