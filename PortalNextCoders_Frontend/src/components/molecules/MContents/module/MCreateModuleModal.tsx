...
import { CreateModuleDto, CreateTrailDto } from "../../../../interfaces/courses/requests/CreatesDto";
...
interface CreateModuleModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onCreate: (formData: CreateModuleDto) => void;
  loading: boolean;
}

export function MCreateModuleModal({
  trailId,
  isOpen,
  onClose,
  onCreate,
