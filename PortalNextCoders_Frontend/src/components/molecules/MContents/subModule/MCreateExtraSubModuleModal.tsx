...
interface CreateExtraSubModuleModalProps {
    moduleId: number;
    isOpen: boolean;
    onClose: () => void;
    onCreate: (formData: CreateExtraSubModuleDto) => void;
    loading: boolean;
}

export function MCreateExtraSubModuleModal({
                                          moduleId,
                                          isOpen,
                                          onClose,
                                          onCreate,
                                          loading,
                                      }: CreateExtraSubModuleModalProps) {
    const [formData, setFormData] = useState<CreateExtraSubModuleDto>({
        extraModuleId: moduleId,
        name: "",
        subModuleTypeId: 1,
        description: "",
        orderNumber: 0,
