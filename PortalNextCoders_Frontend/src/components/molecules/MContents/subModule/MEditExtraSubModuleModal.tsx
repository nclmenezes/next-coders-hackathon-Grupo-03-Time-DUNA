...
interface EditExtraSubModuleModalProps {
    subModule: ExtraSubModule;
    isOpen: boolean;
    onClose: () => void;
    onSave: (updatedSubModule: Partial<ExtraSubModule>) => void;
    loading: boolean;
}

export function MEditExtraSubModuleModal({
                                        subModule,
                                        isOpen,
                                        onClose,
                                        onSave,
                                        loading,
                                    }: EditExtraSubModuleModalProps) {
    const [editedSubModule, setEditedSubModule] = useState<Partial<ExtraSubModule>>(subModule);
