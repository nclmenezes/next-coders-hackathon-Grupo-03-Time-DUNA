...
import {ExtraSubModule} from "../../../interfaces/courses/responses/Course";
import {useExtraCourse} from "../../../context/ExtraCourseProvider/ExtraCourseProvider";
import {MEditExtraSubModuleModal} from "../../molecules/MContents/subModule/MEditExtraSubModuleModal";

interface props {
    key: React.Key;
    subModule: ExtraSubModule;
    to: string;
    onConfirm: () => void;
}

export function OExtraSubModule({ key, subModule, to, onConfirm }: props) {
    const navigate = useNavigate();
    const [currentSubModule, setCurrentSubModule] = useState<ExtraSubModule>(subModule);
    ...
    const handleSaveEdit = async (updateSubModule: Partial<ExtraSubModule>) => {
        setLoadingModal(true)
        try {
            const updateSubModuleData: ExtraSubModule = {
                ...currentSubModule,
                ...updateSubModule,
            };
