...
function TTeamDetailReport() {
    ...
    const handleClassClick = (teamId: number) => {
        navigate(`/reports/assessments/${teamId}`);
    };
    ...
    return (
        <Box>
            <PageHeader>
                <h1>Relatório de alunos detalhado</h1>
            </PageHeader>
...
export default TTeamDetailReport